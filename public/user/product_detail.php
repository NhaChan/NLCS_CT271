<body>
        ...
        <div class="container">
            <div class="row mb-5">
                ...
                <div class="col-sm-6">
                    <div class="row">
                        <?php if ($product) {
                            echo "<h3 class='mt-2'>" . $htmlspecialchars($product['name']) . "</h3>";
                        } ?>
                    </div>
                    <div class="row">
                        <?php
                    ...
                    <div class="row li-describe">
                        ...
                        <div>
                            <?php
                            $text = $htmlspecialchars($product['describe']);
                            $specs = explode(" \ ", $text);
                            echo "<ul>";
                    ...
                    <div class="col-lg-12 mt-4">
                        <div class="row">
                            <div class="col-lg-4 pb-3">
                                <a href="javascript:void(0)" class="btn btn-warning w-100" onclick="addToCart()">
                                    Thêm vào giỏ
                                </a>
                            </div>
                            <div class="col-lg-4 pb-3">
                                <a href="cart.php" class="btn btn-success w-100" onclick="addToCart()">Mua ngay</a>
                            </div>
                        </div>
                    </div>
                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div class="card d-flex h-100">
                                                            <div class="card-body">
                                                                <?= $htmlspecialchars($fetch_user['message']) ?>
                                                            </div>
                                                            <div class="d-flex justify-content-end m-4">
                                                                <i class="fa fa-thumbs-up fs-4 text-light mx-2"></i>
                                                                <i class="fa fa-thumbs-down mt-1 fs-4"></i>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <script>
        ...
        function formatPrice(price) {
            // Chuyển đổi giá về chuỗi và tách phần nguyên và thập phân
            var parts = price.toFixed(0).toString().split(".");
            var integerPart = parts[0];

            // Thêm dấu chấm giữa các nhóm 3 chữ số
            integerPart = integerPart.replace(/\B(?=(\d{3})+(?!\d))/g, ".");

            // Kết hợp lại phần nguyên và thêm vào phần thập phân nếu có
        ...
        function updatePrice(selectedOption) {
            ...
            switch (selectedOption) {
                ...
                case "2":
                    ...
                    break;
                case "3":
                    updatedPrice = currentPrice - (currentPrice * (discount) / 100) + 1700000; //  Áp dụng cho value =3
                    config = " -- [16GB - 512GB]";
                    break;
                default:
                    break;
